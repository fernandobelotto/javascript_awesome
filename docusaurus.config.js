...
const config = {
  ...
  tagline: 'A collection of awesome things regarding the Javascript ecosystem',
  url: 'https://javascript-awesome.vercel.app',
  baseUrl: '/',
  onBrokenLinks: 'throw',
  onBrokenMarkdownLinks: 'warn',
  favicon: 'img/favicon.ico',
  organizationName: 'fernandobelotto', // Usually your GitHub org/user name.
  projectName: 'javascript_awesome', // Usually your repo name.
  presets: [
    [
      'classic',
          ...
          },
          {
            ...
            items: [
              ...
              // },
              {
                ...
                href: 'https://github.com/fernandobelotto/javascript_awesome',
              },
              {
